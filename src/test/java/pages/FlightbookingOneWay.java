...
public class FlightbookingOneWay extends Baseclass{
	...
	@FindBy(xpath = "//div[contains(text(),'Unfortunately, there are no flights available.')]")
	WebElement NoFlight;
	
	public FlightbookingOneWay() {
...
public void searchforflight(String f,String t) throws Exception {
